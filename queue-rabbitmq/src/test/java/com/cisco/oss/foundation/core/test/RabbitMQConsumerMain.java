...
public class RabbitMQConsumerMain {
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger(RabbitMQConsumerMain.class);
    ...
    public static void main(String[] args) throws Exception {
        ...
        Thread t = new Thread(new Runnable() {
            ...
            public void run() {
                ...
                final MessageConsumer consumer1 = RabbitMQMessagingFactory.createConsumer("consumer1");
                consumer1.registerMessageHandler(new AbstractRabbitMQMessageHandler("consumer1") {
                    @Override
...
//        MessageConsumer consumer1 = RabbitMQMessagingFactory.createConsumer("consumer1");
