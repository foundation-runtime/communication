 ...
 */
public class NetflixHttpResponse extends ApacheHttpResponse implements com.netflix.client.http.HttpResponse {
    private URI requestUri = null;
    private byte[] responseBody;
    private boolean isClosed = false;
    private com.netflix.client.http.HttpResponse netflixHttpResponse;

    public NetflixHttpResponse(org.apache.http.HttpResponse httpResponse, URI requestUri, boolean autoCloseable) {
        super(httpResponse, requestUri, autoCloseable);
    }
    public NetflixHttpResponse(com.netflix.client.http.HttpResponse netflixHttpResponse) {
        super();
