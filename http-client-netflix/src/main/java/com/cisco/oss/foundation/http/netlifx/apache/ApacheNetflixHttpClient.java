...
//        throw new UnsupportedOperationException("executeWithLoadBalancer is currently not supported");
    ...
    @Override
    public void executeWithLoadBalancer(HttpRequest request, ResponseCallback<ApacheNetflixHttpResponse> responseCallback) {
...
//            protected HttpResponse run() throws Exception {
        ...
        ApacheNetflixHttpResponse netflixHttpResponse = new ApacheNetflixHttpResponse(response, requestUri, autoCloseable);
